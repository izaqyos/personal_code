...
public class CompletableFutureDemo {
    public static void main(String[] args) throws Exception {
        ...
        String res1, res3;
        CompletableFuture<String> firstCompleted = future1.thenCombine(future2, (re1, res2) -> res1+res2);
        firstCompleted.thenAccept(System.out.println("Combined result of two futures: " + res3));
