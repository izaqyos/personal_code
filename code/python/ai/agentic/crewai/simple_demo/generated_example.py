...
writing_task = Task(
    description='Write a 500-word blog post about the findings from the research on AI and specifically on Ladvancements in LLMs capabilities for reasoning and complex problem solving .',
    agent=writer,
