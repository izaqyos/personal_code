...
from src.banner.renderer import (
    BannerData,
    render_banner_renderable,
    render_banner_text,
    render_error_banner,
    render_error_renderable,
)
...
def render_banner_renderable_for(
    args: Any,
    config: Any,
    today: date | None = None,
    width: int | None = None,
) -> "RenderableType | None":
    """Same as render_banner but returns a Rich renderable for embedding in a Live display.
    ...
    if text_only:
        ...
        return render_banner_renderable(data, width)
    ...
    try:
        ...
        if isinstance(exc, MalformedScheduleError):
            ...
            kind = "missing"
            reason = ""
        return render_error_renderable(
