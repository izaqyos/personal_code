 ...
 *       Filename:  auto.cpp
 *
 *    Description:  Demo C14 features 
 *
 *        Version:  1.0
 *        Created:  Thu Sep 17 11:16:21 IDT 2015
 *       Revision:  none
 *       Compiler:  gcc
 *
 *         Author:  Yosi Izaq
...
int main(){
    printf("1. Demo auto keyword:\n");
    printf("First for iterators:\n");
    printf("{");
    for (auto itr = begin(my_map) ; itr != end(my_map) ; ++itr)
    {
    ...
    auto compF = [] (const auto & p1,  const auto & p2  ) { return *p1 < *p2; } ;
    auto num1 = 5;
    auto num2 = 7;
    printf("Second for lambadas function type:\n");
    printf("Activate auto type ptr to a comparation lambada function:\n");
    printf("%d is %s than %d:\n", num1, compF(&num1, &num2) ? "smaller": "bigger", num2);
