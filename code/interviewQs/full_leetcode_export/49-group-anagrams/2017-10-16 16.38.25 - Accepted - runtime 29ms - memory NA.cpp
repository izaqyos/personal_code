...
//{a , 2},{  b, 3 },{  c, 5 },{  d, 7 },{  e, 9 },{  f, 11 },{  g, 13 },{  h, 15 },{  i, 17 },{  j, 19 },{  k, 21 },{  l, 23 },{  m, 25 },{  n, 27 },{  o, 29 },{  p, 31 },{  q, 33 },{  r, 35 },{  s, 37 },{  t, 39 },{  u, 41 },{  v, 43 },{  w, 45 },{  x, 47 },{  y, 49 },{  z, 51 }
        vector<pair<char,int>> chars = { {'a' , 2},{  'b', 3 },{  'c', 5 },{  'd', 7 },{  'e', 11 },{  'f', 13 },{  'g', 17 },{  'h', 19 },{  'i', 23 },{  'j', 29 },{  'k', 31 },{  'l', 37 },{  'm', 41 },{  'n', 43 },{  'o', 47 },{  'p', 53 },{  'q', 59 },{  'r', 61 },{  's', 67 },{  't', 71 },{  'u', 73 },{  'v', 79 },{  'w', 83 },{  'x', 89 },{  'y', 97 },{  'z', 101 }  };
    ...
    unordered_map<int, vector<string>> Anagrams;
        ...
        {    
            hashV = calcHash(s);
            //cout<<"word: "<<s<<", hash: "<<hashV<<endl;
            Anagrams[hashV].insert(Anagrams[hashV].begin(),  s);
        }
