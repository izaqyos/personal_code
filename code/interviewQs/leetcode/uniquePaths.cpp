...
void testSolution(){
    ...
    dimensions.push_back(make_pair(0,0));
    dimensions.push_back(make_pair(0,3));
    dimensions.push_back(make_pair(5,0));
    dimensions.push_back(make_pair(3,2));
    dimensions.push_back(make_pair(5,5));

    Solution sol = Solution();
    for(auto pair : dimensions){
        cout<<"# of unique paths for ("<<pair.first<<", "<<pair.second<<") is: "<<sol.uniquePaths(pair.first, pair.second)<<endl;
    }
}
