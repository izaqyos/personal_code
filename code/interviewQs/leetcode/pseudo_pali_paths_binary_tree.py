...
idea:
    DFS traverse tree. 
    upon reaching leave pass the path the pseudo-palindromic test 
    e.g. it's either even and the letter freq are even 
    or it's odd and all letter frequence is even except one which is odd 
    so since we have 9 digits we can test at least 8 freq is even. this means its a pseudo-palindrome
"""
