...
The framework includes comprehensive tests to ensure reliability and performance.
...
Run integration tests (requires a running MCP server):
```bash
...
See [TESTING.md](TESTING.md) for more detailed information on tests and test coverage.
