...
print "Any .py file is considered a module and can be reused. to do so use import <module>. The module name is accessible via __name__ member"
print "For example, import fibo module."
import fibo
print "Loaded module name: ", fibo.__name__

"""
This does not enter the names of the functions defined in fibo directly in the current symbol table; it only enters the module name fibo there. Using the module name you can access the functions:
"""

print "calling fib(1000): ",fibo.fib(1000)
print "generating list of fib 100: ", fibo.fib2(100)

print "If you intend to use a function often you can assign it to a local name:"
print "like fib = fibo.fib"
fib = fibo.fib
print "calling fib(500)", fib(500)

"""
print "The symbols from the modul are not eneterd dierectly to the current symbol table. To access them use <module>.<symbol>."
print "It is also possible to assign them to local symbols. <myfunc> = <module>.func"
print "for example ask_user=basics1.ask_user"
ask_user=basics1.ask_user
print "Calling the local symbol: ", ask_user
ask_user
...
While this feature is not often needed, it can be used to extend the set of modules found in a packag6. Modules
...
While this feature is not often needed, it can be used to extend the set of modules found in a packagee
"""
